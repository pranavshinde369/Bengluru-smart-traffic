...
const defaultZones: ZonePixel[] = [
  { name: 'Silk Board Junction', x1: 80, y1: 120, x2: 400, y2: 360 },
  { name: 'KR Market', x1: 50, y1: 90, x2: 350, y2: 310 },
  { name: 'MG Road', x1: 100, y1: 100, x2: 450, y2: 380 },
];
...
const Settings = () => {
  ...
  const [activeJunctions, setActiveJunctions] = useState<string[]>(() => {
    ...
    return saved ? JSON.parse(saved) : ['Silk Board Junction', 'MG Road'];
  });
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 ml-[220px] transition-all duration-300 min-h-screen flex flex-col">
        ...
        <div className="flex-1 p-6 space-y-6 overflow-y-auto max-w-3xl">
          ...
          {/* Priority Corridor Mode Configuration */}
          <div className="dashboard-card space-y-4">
            <h3 className="text-sm font-semibold text-foreground">Priority Corridor Mode Configuration</h3>
            <p className="text-xs text-muted-foreground">
              Override signal timing during VIP Escorts, emergencies, and large public events.
            </p>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                All selected junctions will hold green for this duration during Priority Corridor mode.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Primary contact for Priority Corridor mode activation alerts.
              </p>
            </div>
          </div>
