...
import { ParkIQSection } from './ParkIQSection';
...
const parkingData = [
  { zone: 'KR Market', incidents: 847, severity: 'Critical' },
  { zone: 'MG Road', incidents: 612, severity: 'High' },
  { zone: 'Hebbal', incidents: 534, severity: 'High' },
  { zone: 'Whitefield', incidents: 389, severity: 'Medium' },
  { zone: 'Indiranagar', incidents: 298, severity: 'Medium' },
];
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="dashboard-card">
          ...
          <p className="text-xs text-muted-foreground mb-4">Average vehicle wait time at Silk Board Junction</p>
        ...
        <div className="dashboard-card">
          ...
          <p className="text-[10px] text-muted-foreground mt-2">● Data-driven BTP infrastructure recommendation</p>
        </div>
      </div>
