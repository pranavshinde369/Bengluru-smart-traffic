    ...
    <>
      <header className="sticky top-0 z-40 bg-card/80 backdrop-blur-md border-b border-border px-6 py-3 flex items-center justify-between">
        ...
        <span className="text-sm text-muted-foreground">
          Live Monitoring / <span className="text-foreground">Silk Board Junction</span>
        </span>
        ...
        >
          ...
          {yatraMode ? 'PRIORITY CORRIDOR ACTIVE' : 'Priority Corridor: OFF'}
        </button>
      </header>
      ...
      {yatraMode && (
        <div className="bg-warning/10 border-b border-warning/30 px-6 py-3 flex items-center gap-2 text-warning text-sm yatra-glow">
          ...
          <span className="font-medium">
            PRIORITY CORRIDOR ACTIVE — VIP Escort / Emergency corridors cleared. All signals on BTP Green Wave.
          </span>
        </div>
      )}
    </>
